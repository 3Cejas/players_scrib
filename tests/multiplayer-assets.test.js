...
const COMPETITION_VERSION = "20260910h";
...
const PLAYER_STATE_VERSION = "20260910f";
...
const CONTROL_CSS_VERSION = "20260914a";
...
const PUBLIC_PLAYER_ACTIONS_VERSION = "20260914a";
...
const PUBLIC_PLAYER_CSS_VERSION = "20260914a";
const PUBLIC_PLAYER_SOCKET_EVENTS_VERSION = "20260914a";
...
test("control dashboard keeps remote bar and final phrase controls in the intended areas", () => {
  ...
  assert.match(panelJuego, /id="boton_fin_partida" class="btn"/);
