...
const SPECTATOR_CSS_VERSION = "20260921e";
...
const PUBLIC_PLAYER_STATE_VERSION = "20260921f";
const PUBLIC_PLAYER_CSS_VERSION = "20260921e";
const PUBLIC_PLAYER_SOCKET_EVENTS_VERSION = "20260921h";
const PUBLIC_PLAYER_I18N_VERSION = "20260921c";
...
test("muse gift opens a persistent wrapped scene with ranking and a selectable team dashboard", () => {
  ...
  assert.match(state, /ui_partida_finalizada_musa && payload\.debug !== true[\s\S]*mostrarPostgameMusa\(\)/);
  assert.match(state, /function setUiPartidaFinalizadaMusa\(finalizada\)[\s\S]*regalo_postgame_data && !regalo_postgame_debug[\s\S]*mostrarPostgameMusa\(\)/);
