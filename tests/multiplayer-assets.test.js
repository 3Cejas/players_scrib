...
const CONTROL_CSS_VERSION = CONTROL_HELP_VERSION;
const CONTROL_ACTIONS_VERSION = CONTROL_HELP_VERSION;
const CONTROL_STATE_VERSION = PLAYER_DISCARD_VERSION;
const CONTROL_SOCKET_EVENTS_VERSION = CONTROL_AUTH_VERSION;
