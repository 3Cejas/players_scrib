...
const SPECTATOR_STATE_VERSION = "20260906b";
...
const PLAYER_ACTIONS_VERSION = "20260905c";
const PLAYER_STATE_VERSION = "20260905d";
const PLAYER_SOCKET_EVENTS_VERSION = "20260905d";
const SPECTATOR_SOCKET_EVENTS_VERSION = "20260906a";
const JURY_CSS_VERSION = "20260904a";
const JURY_STATE_VERSION = "20260904a";
const JURY_SOCKET_EVENTS_VERSION = "20260904a";
const CONTROL_CSS_VERSION = "20260906b";
const CONTROL_ACTIONS_VERSION = "20260905e";
...
const MUSA_SELECTOR_VERSION = "20260906a";
...
const PUBLIC_PLAYER_SOCKET_EVENTS_VERSION = "20260905b";
...
test("control dashboard keeps remote bar and final phrase controls in the intended areas", () => {
  ...
  assert.match(css, /\.remote-brand-card \.control-brand-logo\s*\{[\s\S]*object-fit: contain;[\s\S]*transform: scale\(1\.58\);[\s\S]*drop-shadow/);
  assert.match(css, /\.control-debug-secret-trigger\s*\{[\s\S]*place-items: center;[\s\S]*overflow: hidden;/);
  assert.match(css, /\.remote-brand-control-label\s*\{[\s\S]*font-family: "Retro-gaming", "Courier New", monospace;[\s\S]*font-size: clamp\(0\.94rem, 1\.18vw, 1\.38rem\);[\s\S]*text-shadow:/);
