...
const SPECTATOR_STATE_VERSION = "20260905b";
const SPECTATOR_CSS_VERSION = "20260905b";
...
const PUBLIC_PLAYER_STATE_VERSION = "20260904a";
const PUBLIC_PLAYER_CSS_VERSION = "20260904a";
...
test("control dashboard keeps remote bar and final phrase controls in the intended areas", () => {
  ...
  assert.match(html, /data-control-section="debug"/);
  ...
  assert.equal((html.match(/class="[^"]*control-collapsible[^"]*is-collapsed/g) || []).length, 7);
