...
const CONTROL_CSS_VERSION = CONTROL_FINISH_VERSION;
const CONTROL_ACTIONS_VERSION = CONTROL_FINISH_VERSION;
const CONTROL_STATE_VERSION = PLAYER_DISCARD_VERSION;
const CONTROL_SOCKET_EVENTS_VERSION = CONTROL_FINISH_VERSION;
...
test("control dashboard keeps remote bar and final phrase controls in the intended areas", () => {
  ...
  assert.equal((html.match(/class="[^"]*control-collapsible[^"]*is-collapsed/g) || []).length, 3);
