function MtrDatepicker(e) {
    ...
    var l, c = {
        ...
        switch (e) {
          ...
          case "ampm":
            ...
            t !== a && (!0 === t && 23 < s ? i = s - 23 : !0 === t && 12 === s ? i = 0 : !1 === t && s < 12 ? i = s + 12 : !1 === t && 12 === s && (i = 12)), 
            r.setHours(i);
            break;
        ...
        k(a = 0 === a ? 60 : a), E(n), S(i), P(o), M(s), w(r);
    }, O = function(e, t, a) {
        var n, r, s, i, o, m = G(e);
        ...
        Z(t, "mtr-error"), setTimeout(function() {
            R(t, "mtr-error");
        }, c.transitionValidationDelay + 120);
    }, F = function(e, t) {
    ...
    var B = function(n, e, t) {
        ...
        return 1 < c.minutes.step && (a = (t - e % 60) % e), e + a;
    }, K = null, Q = null;
    function $() {
