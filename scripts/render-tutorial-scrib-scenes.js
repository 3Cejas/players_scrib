...
const scenes = [
  ...
  { key: "01-acceso", start: 8, duration: 9, leadMs: 320, caption: "Para empezar, abre en tu móvil el enlace de esta pantalla.", narration: "Para empezar, abre en tu móvil el enlace que ves en esta pantalla.", voiceRate: "-4%", voicePitch: "+2Hz", eyebrow: "PASO 1 · CONEXIÓN", title: "ABRE EL ENLACE\nEN TU MÓVIL", note: "Tómate un momento. Al cargarlo verás la bienvenida real de SCRIB.", screen: "welcome" },
  { key: "02-omitir", start: 17, duration: 9, leadMs: 320, caption: "En la bienvenida, pulsa OMITIR TUTORIAL.", narration: "En la bienvenida, pulsa omitir tutorial.", voiceRate: "-3%", voicePitch: "+2Hz", eyebrow: "PASO 2 · ACCESO RÁPIDO", title: "PULSA\n“OMITIR TUTORIAL”", note: "Ese botón te lleva directamente a elegir tu nombre.", screen: "skip" },
  { key: "03-nombre", start: 26, duration: 9, leadMs: 320, caption: "Escribe tu nombre de musa y avanza con la flecha azul.", narration: "Escribe tu nombre de musa, y avanza con la flecha azul.", voiceRate: "-3%", voicePitch: "+2Hz", eyebrow: "PASO 3 · NOMBRE", title: "ESCRIBE CÓMO\nQUIERES APARECER", note: "Este es el nombre que verá el público con tus mensajes.", screen: "name" },
  { key: "04-asignacion", start: 35, duration: 9, leadMs: 320, caption: "Pulsa DESCUBRIR MI EQUIPO para saber cuál te ha tocado.", narration: "Pulsa descubrir mi equipo para saber cuál te ha tocado.", voiceRate: "-3%", voicePitch: "+2Hz", eyebrow: "PASO 4 · EQUIPO", title: "DESCUBRE\nTU EQUIPO", note: "La pantalla te mostrará si eres del equipo azul o del equipo rojo.", screen: "assignment" },
  { key: "05-resultado", start: 44, duration: 9, leadMs: 320, caption: "Aquí aparecen tu equipo y tu escritxr. Después, entra al juego.", narration: "Verás tu equipo y quién escribe contigo. Después, entra.", voiceRate: "-2%", voicePitch: "+1Hz", eyebrow: "PASO 5 · RESULTADO", title: "REVISA TU EQUIPO\nY TU ESCRITXR", note: "Lee ambos datos y, cuando estés preparada, entra al juego.", screen: "reveal" },
  { key: "06-aviso", start: 53, duration: 7, leadMs: 260, caption: "¡Muy bien! Ahora vamos a probar los colores.", narration: "¡Muy bien! Ahora, probemos los colores.", voiceRate: "-2%", voicePitch: "+4Hz", eyebrow: "PRUEBA DE PANTALLA", title: "MIRA TU MÓVIL", note: "La aplicación cubrirá tu pantalla con cuatro colores.", screen: "warning", remaining: "00:47" },
  { key: "07-rojo", start: 60, duration: 5, leadMs: 520, caption: "ROJO", narration: "¡Rojo!", voiceRate: "-8%", voicePitch: "+5Hz", eyebrow: "COLOR 1 DE 4", title: "ROJO", note: "Tu móvil mostrará esta pantalla roja.", screen: "color", colorName: "ROJO", color: "#f20d35", remaining: "00:40" },
  { key: "08-azul", start: 65, duration: 5, leadMs: 520, caption: "AZUL", narration: "¡Azul!", voiceRate: "-8%", voicePitch: "+5Hz", eyebrow: "COLOR 2 DE 4", title: "AZUL", note: "Después la pantalla cambia a azul.", screen: "color", colorName: "AZUL", color: "#0965ff", remaining: "00:35" },
  { key: "09-verde", start: 70, duration: 5, leadMs: 520, caption: "VERDE", narration: "¡Verde!", voiceRate: "-8%", voicePitch: "+5Hz", eyebrow: "COLOR 3 DE 4", title: "VERDE", note: "El tercer color es verde.", screen: "color", colorName: "VERDE", color: "#00b65c", remaining: "00:30" },
  { key: "10-blanco", start: 75, duration: 5, leadMs: 520, caption: "BLANCO", narration: "¡Blanco!", voiceRate: "-8%", voicePitch: "+5Hz", eyebrow: "COLOR 4 DE 4", title: "BLANCO", note: "Por último verás la pantalla blanca.", screen: "color", colorName: "BLANCO", color: "#ffffff", remaining: "00:25" },
  { key: "11-confirmacion", start: 80, duration: 9, leadMs: 320, caption: "Si viste los cuatro colores, pulsa el botón verde para confirmar.", narration: "Si viste los cuatro colores, pulsa el botón verde para confirmar.", voiceRate: "-3%", voicePitch: "+2Hz", eyebrow: "ÚLTIMO PASO", title: "PULSA\n“SÍ, FUNCIONA”", note: "Usa el botón verde que aparece realmente en tu móvil.", screen: "confirm", remaining: "00:20" },
  { key: "12-verificada", start: 89, duration: 5, leadMs: 220, caption: "¡Perfecto! Tu pantalla está lista.", narration: "¡Perfecto! Tu pantalla está lista.", voiceRate: "-3%", voicePitch: "+4Hz", eyebrow: "CONEXIÓN COMPLETA", title: "TODO LISTO", note: "La confirmación se muestra en tu propia pantalla.", screen: "verified", remaining: "00:11" },
  { key: "13-despedida", start: 94, duration: 6, leadMs: 180, caption: "Gracias por acompañarnos. ¡Nos vemos dentro!", narration: "Gracias por acompañarnos. ¡Disfruta, y nos vemos dentro!", voiceRate: "-2%", voicePitch: "+4Hz", eyebrow: "YA ESTÁS PREPARADA", title: "¡GRACIAS,\nMUSA!", note: "Disfruta, participa y ayuda a dar vida a la historia.", screen: "verified", remaining: "00:06" }
];
...
function realScreen(scene, assets) {
  ...
  const title = scene.screen === "warning" ? "PREPARA TU PANTALLA" : scene.screen === "confirm" ? "¿VISTE LOS CUATRO COLORES?" : scene.screen === "verified" ? "CONFIGURACIÓN VERIFICADA" : scene.colorName;
  const copy = scene.screen === "warning" ? "Ahora comprobaremos juntos el color y el brillo." : scene.screen === "confirm" ? "Confirma para terminar la prueba de este dispositivo." : scene.screen === "verified" ? "Tu dispositivo está conectado y listo para inspirar." : "";
  return `<div class="calibration${phaseClass}${scene.screen === "verified" ? " calibration--verified" : ""}"${phaseStyle}><div class="calibration-grid"></div><div class="calibration-card">${scene.screen === "verified" ? '<div class="verified-check">✓</div>' : ""}${scene.screen !== "color" ? `<span class="calibration-kicker">${scene.screen === "verified" ? "TODO FUNCIONA" : "PRUEBA DE CONEXIÓN"}</span>` : ""}<h2>${title}</h2>${copy ? `<p>${copy}</p>` : ""}${scene.screen !== "color" ? '<div class="identity">LUNA · EQUIPO AZUL · ESCRITXR: ALEX</div>' : ""}${scene.screen === "confirm" ? '<button>SÍ, FUNCIONA</button>' : ""}<small class="device-time">${scene.remaining || (scene.screen === "warning" ? "00:30" : scene.screen === "confirm" ? "00:10" : "00:04")}</small></div></div>`;
}

function sceneHtml(scene, assets) {
  const accent = scene.color || (scene.screen === "verified" || scene.screen === "confirm" ? "#70ff9a" : "#45e6ff");
