...
socket.on('nueva letra', (letra) => {
    ...
    const valorRaw = (letra && typeof letra === "object")
        ? (letra.letra || letra.letra_bendita || letra.letra_prohibida || "")
        : letra;
    const valor = String(valorRaw || "").toUpperCase();
    if (!valor) return;
...
function downloadTxtFile(filename, htmlContent) {
    ...
    let contentWithNewlines = htmlContent
        .replace(/<br\s*\/?>/gi, '\n')               // Reemplaza <br> por saltos de linea
        .replace(/<\/div>\s*<div>/gi, '\n')          // Reemplaza el cierre y apertura de <div> consecutivos por un salto de linea
...
function descargar_textos(opciones = {}) {
    ...
    const scrib_logo =  'data:image/png;base64,';
     // Tamano original y calculo para logos
